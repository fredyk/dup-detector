...
- [ ] **#16 (RAM — secundario, NO mató el proceso)** Spike transitorio de `FileStore.FilesUnderDir` (vía CGo
  ...
  strings. ACEPTADO/pendiente: streamear la verificación de cobertura sin materializar la lista completa.
